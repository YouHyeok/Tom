        ...
        ZStack {
            ...
            VStack {
                ...
                Button(action: {
                    ...
                    if selectedUser == false {
                        jun.deployBlogs(url: "http://221.159.102.58:8000/api/trigger/deploy/blogs", bodyl: ["user": "Jun", "blog": selectedYBCategories], completion: { (results) in
                            
                            alertShowing = true
                        })
                    } else {
                        jong.triggerGIT(url: "http://221.159.102.58:8000/api/trigger/deploy/blogs", bodyl: ["user": "Jong", "blog": selectedJBCategories], completion: { (results) in
